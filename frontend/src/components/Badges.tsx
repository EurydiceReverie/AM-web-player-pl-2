...
export function ExplicitBadge({ className }: { className?: string }) {
  return (
    <span
      title="Explicit"
      className={cn(
        "inline-grid place-items-center h-[14px] w-[14px] rounded-[3px] bg-white/55 text-black text-[9px] font-bold leading-none",
        className,
      )}
    >
      E
...
export function HighQualityBadge({ className }: { className?: string }) {
  return (
    <svg 
